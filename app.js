...
const T = {
  de: {
    ...
    s6_a2: "Wir hatten in den letzten drei Jahrzehnten Kollegen aus über zwanzig Ländern. Verständliches Deutsch reicht für den Start. Im Alltag sprechen wir auch Russisch, Rumänisch und Türkisch — niemand wird abgewiesen, weil ein Wort fehlt.",
    s6_q3: "Wie wird die Vergütung besprochen?",
    s6_a3: "Persönlich im Vorstellungsgespräch. Wir nennen keine Lockzahlen auf der Webseite, weil die Vergütung von Einsatzort, Tour und Erfahrung abhängt. Im Gespräch sagen wir Ihnen eine konkrete Zahl — und die gilt auch.",
    ...
    s6_a6: "In der Regel ein bis zwei Wochen, bei Bedarf länger. Es gibt keine festen Stoppuhren — Sie übernehmen eine Tour, wenn Sie und Ihr Einarbeiter sich einig sind, dass es passt.",
  ...
  ru: {
    ...
    s3_t2_time: "07:00 – 08:30", s3_t2_loc: "Подготовка маршрута", s3_t2_title: "Сканирование, сортировка, проверка",
    s3_t2_desc: "Вы сканируете отправления, сортируете их по порядку остановок и проверяете экспресс. Когда всё готово, выезжаете — обычно в первой половине восьмого часа.",
    s3_t3_time: "08:30 – после полудня", s3_t3_loc: "В пути", s3_t3_title: "Ваш маршрут, Ваш ритм",
    ...
    s3_t4_time: "13:00 – 13:45", s3_t4_loc: "Перерыв", s3_t4_title: "Обязательный по закону перерыв",
    ...
    s3_t5_time: "13:45 – 15:30", s3_t5_loc: "Дозаказы и заборы", s3_t5_title: "Вторая половина дня",
    ...
    s3_t6_time: "После маршрута", s3_t6_loc: "Депо и конец смены", s3_t6_title: "Завершение в депо",
    ...
    s3_t7_time: "Первые недели", s3_t7_loc: "Адаптация", s3_t7_title: "Время обучения — это рабочее время",
  ...
  ro: {
    ...
    s3_t2_time: "07:00 – 08:30", s3_t2_loc: "Pregătirea traseului", s3_t2_title: "Scanare, sortare, verificare",
    s3_t2_desc: "Scanați coletele, le sortați după ordinea opririlor și verificați expresurile. Când totul este gata, plecați — de obicei în prima jumătate a celei de-a opta ore.",
    s3_t3_time: "08:30 – după-amiază", s3_t3_loc: "Pe traseu", s3_t3_title: "Traseul Dvs., ritmul Dvs.",
    ...
    s3_t4_time: "13:00 – 13:45", s3_t4_loc: "Pauză", s3_t4_title: "Pauză obligatorie prin lege",
    ...
    s3_t5_time: "13:45 – 15:30", s3_t5_loc: "Livrări rămase și ridicări", s3_t5_title: "A doua jumătate a zilei",
    ...
    s3_t6_time: "După traseu", s3_t6_loc: "Depozit și sfârșit", s3_t6_title: "Încheierea la depozit",
    ...
    s3_t7_time: "Primele săptămâni", s3_t7_loc: "Instruire", s3_t7_title: "Timpul de învățare este timp de lucru",
  ...
  tr: {
    ...
    s3_t2_time: "07:00 – 08:30", s3_t2_loc: "Tur hazırlığı", s3_t2_title: "Paketleri tarayın, sıralayın, kontrol edin",
    s3_t2_desc: "Gönderilerinizi tararsınız, durak sırasına göre sıralarsınız ve ekspresleri kontrol edersiniz. Hepsi hazır olduğunda yola çıkarsınız — genellikle sekizinci saatin ilk yarısında.",
    s3_t3_time: "08:30 – öğleden sonra", s3_t3_loc: "Tur üzerinde", s3_t3_title: "Sizin rotanız, sizin ritminiz",
    ...
    s3_t4_time: "13:00 – 13:45", s3_t4_loc: "Mola", s3_t4_title: "Yasal zorunlu mola",
    ...
    s3_t5_time: "13:45 – 15:30", s3_t5_loc: "Kalan teslimatlar ve alımlar", s3_t5_title: "Günün ikinci yarısı",
    ...
    s3_t6_time: "Turdan sonra", s3_t6_loc: "Depo ve paydos", s3_t6_title: "Depoda bitiriş",
    s3_t6_desc: "Gerekirse aracı yıkarsınız. Turda konuşulacak bir şey varsa, doğrudan sevkiyatla halledersiniz. Sonra paydos.",
    s3_t7_time: "İlk haftalar", s3_t7_loc: "Eğitim", s3_t7_title: "Öğrenme zamanı çalışma zamanıdır",
